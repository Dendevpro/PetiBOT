...
try:
    ...
    print("Please run: pip install python-docx Pillow PyPDF2 reportlab anthropic")
...
class DocumentAutomation:
    ...
    def summarize_with_claude(self, text: str) -> str:
        """
...
Forneça apenas o resumo, sem introdução ou explicações adicionais."""
            ...
            message = self.client.messages.create(
                model="claude-3-5-sonnet-20240620",  # Fast and cost-effective
                max_tokens=1024,
                messages=[
...
Sistema de Automação de Documentos
    ...
    def process_document(
        ...
        try:
            ...
            summary = self.summarize_with_claude(text)
...
if __name__ == '__main__':
    ...
    if not config.get('claude_api_key'):
        ...
        print("  - claude_api_key: Your Anthropic Claude API key")
